...
//	네이버 로그인 API 등록시 발급받은 Client ID, Client Secret과 Callback URL을 입력한다.
	private final static String CLIENT_ID = "cv_ORk75Bxv7A17UFS68";
	private final static String CLIENT_SECRET = "DujcAOvJS4";
	private final static String REDIRECT_URI = "http://localhost:8080/springWEB_NaverLoginAPI/callback";
	
	private final static String SESSION_STATE = "oauth_state";
//	프로필 조회 API URL
	private final static String PROFILE_API_URL = "http://openapi.naver.com/v1/nid/me";
